...
@section('content')
  ...
  <section class="bg-white py-2" id="villages">
    <div class="container">
      <div class="text-center py-4">
        {{-- <h3 class="text-uppercase"><a href="{{ Nav::isRoute('villages') }}" class="text-dark">Pemetaan Gampong</a></h3> --}}
  ...
  <section class="py-4" id="profiles">
    <div class="container">
      <div class="text-center py-4">
        ...
        <h5 class="section-subheading text-muted">Profil singkat dinas pemberdayaan masyarakat dan gampong kota langsa</h5>
  ...
  <section class="bg-white py-4" id="news">
    <div class="container">
      <div class="text-center py-4">
        ...
        <h5 class="section-subheading text-muted">Berita terbaru mengenai Dinas Pemberdayaan Masyarakat dan Gampong Kota Langsa</h5>
      </div>
  ...
  <section class="bg-white py-4" id="village">
    ...
    <iframe class="justify-content-center" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7955.359550010882!2d97.95929297804835!3d4.470484170367691!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30379b2c36ba7715%3A0x4a9da539fdc69a89!2sKantor%20Badan%20Pemberdayaan%20Masyarakat%20Kota%20Langsa!5e0!3m2!1sid!2sid!4v1642556508010!5m2!1sid!2sid" height="400" width="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
  </div>
  </section> --}}
@endsection
